...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xmidas-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14938&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xmidas-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xmidas` can be installed with:

```
conda install xmidas
```

It is possible to list all of the versions of `xmidas` available on your platform with:
